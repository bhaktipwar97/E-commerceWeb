    ...
    <nav className="sticky top-0 z-50 bg-[#0f172a]/95 backdrop-blur-md text-white shadow-2xl border-b border-slate-800">
      ...
      <div className="w-full px-8 py-4 flex items-center justify-between">
        ...
        <Link
          ...
          className="text-4xl font-extrabold tracking-wide text-cyan-400 hover:text-cyan-300 transition duration-300"
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          >
            ...
            <span className="bg-red-500 text-xs px-2 py-1 rounded-full text-white">
          ...
          {token && (
            ...
            <>
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-xl bg-red-500 hover:bg-red-600 hover:scale-105 transition-all duration-300 shadow-lg"
